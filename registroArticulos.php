...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    } else if (leer_categoria($cat) == null) {
...
<form method="post" action="registroArticulos.php"
	...
	Nombre: <input type="text" name="nombre" value="<?php echo $nom ?>">
		<?php echo $val_nom ?><br> Subcategoria: <input type="number"
		name="subcat" value="<?php echo $sub ?>">
		<?php echo $val_sub ?><br> Categoria: <input type="number" name="cat"
		value="<?php echo $cat ?>">
		<?php echo $val_cat ?><br> Descripcion:
	<textarea name="descrip" value="<?php echo $des ?>"></textarea>
		<?php echo $val_des ?><br> Precio: <input type="number" name="precio"
		value="<?php echo $pre ?>">
		<?php echo $val_pre ?><br> Imagen: <input type="file" name="foto"
		value="<?php echo $fot ?>"><br> <br> <br> <input type="submit"
		value="Registrar">
