...
<input type="number" name="cant" value=1 min=1 style="width:3em">
<button class=" bg-primary  rounded float-center align-middle" type="submit" name="art" value="<?php echo $id_pag?>">
